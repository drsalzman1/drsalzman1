...
function getPlausible(cardV, p) {
    ...
    let u = 0;
    displayHands(cardV, "Unscrambled");
    for (let c = 0; c < cards; c++)
...
function setSizes() {
    ...
    diagText.innerText = `vh:${vh}, vw:${vw}, wh:${window.innerHeight}, ww:${window.innerWidth} (3)`;
