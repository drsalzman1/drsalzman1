...
const appStaticResources = [
    ...
    "icons/0-0.svg", "icons/0-1.svg", "icons/0-2.svg", "icons/0-3.svg", "icons/0-4.svg", "icons/1-1.svg", 
    "icons/1-2.svg", "icons/1-3.svg", "icons/1-4.svg", "icons/2-2.svg", "icons/2-3.svg", "icons/2-4.svg", 
    "icons/3-3.svg", "icons/3-4.svg", "icons/4-4.svg", "icons/analytics.svg", "icons/any.png", "icons/any.svg", 
    "icons/back.svg", "icons/checked.svg", "icons/close.svg", "icons/east.svg", "icons/exit.svg", "icons/help.svg", 
    "icons/info.svg", "icons/maskable.png", "icons/menu.svg",  "icons/next.svg", "icons/north.svg", "icons/refresh.svg", 
    "icons/settings.svg", "icons/south.svg", "icons/unchecked.svg", "icons/west.svg", 
